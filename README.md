...
<head>
  ...
  <title>Chequeándome — Chatbot</title>
  <style>
...
<body>
  ...
  <header>
    <img src="2.svg" alt="Logo" class="header-image" />
  ...
  <input type="text" id="mensaje" placeholder="Pregunta a Chequeándome" />
  ...
  <script>
    ...
    function enviar() {
      ...
      fetch("https://hook.us2.make.com/le5frbwcdqj4yumecvozhjkh89l25ql1", {
        method: "POST",
